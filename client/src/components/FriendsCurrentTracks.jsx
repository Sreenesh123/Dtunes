  ...
  useEffect(() => {
    const fetchFriendsTracks = async () => {
      try {
        ...
        console.log(response.data.friendsCurrentTracks);
        console.log(friendsTracks)
        friendsTracks.map((track,index)=>
        {
   ...
   useEffect(() => {
     console.log("Friends Tracks Updated:", friendsTracks);
   setnewFriendsTracks(friendsTracks)
   console.log(newfriendsTracks)
   }, [friendsTracks]);
